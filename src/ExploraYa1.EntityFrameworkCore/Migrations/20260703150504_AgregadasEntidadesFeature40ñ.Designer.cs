...
namespace ExploraYa1.Migrations
{
    ...
    [Migration("20260703150504_AgregadasEntidadesFeature40ñ")]
    partial class AgregadasEntidadesFeature40ñ
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExploraYa1.Destinos.Favorito", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("UserId", "DestinoTuristicoId")
                        .IsUnique();
            ...
            modelBuilder.Entity("ExploraYa1.Experiencias.Experiencia", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ExploraYa1.Monitoreo.ApiExternaLog", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppApiExternaLogs", (string)null);
                });

            modelBuilder.Entity("ExploraYa1.Notificaciones.Notificacion", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ExploraYa1.UserProfiles.UserProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ExploraYa1.Experiencias.Experiencia", b =>
                {
                    b.HasOne("ExploraYa1.Destinos.DestinoTuristico", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ExploraYa1.Destinos.Region", b =>
                {
                    b.Navigation("DestinosTuristicos");
                });
