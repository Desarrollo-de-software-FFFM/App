...
namespace ExploraYa1.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("ExploraYa1") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "ExploraYa1", DisplayName = "ExploraYa1 API", Resources = { "ExploraYa1" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        {
            var swaggerRootUrl = configurationSection["ExploraYa1_Swagger:RootUrl"]?.TrimEnd('/');
