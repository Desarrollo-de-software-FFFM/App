...
public class ExploraYa1DomainSharedModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<ExploraYa1DomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<ExploraYa1Resource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/ExploraYa1");

            options.DefaultResourceType = typeof(ExploraYa1Resource);
        ...
        {
            options.MapCodeNamespace("ExploraYa1", typeof(ExploraYa1Resource));
        });
    }
}
